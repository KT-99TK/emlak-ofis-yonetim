...
import { FileText, Paperclip, Plus, RefreshCw } from "lucide-react";
...
export default function ContractFormTemplates() {
  ...
  return <div className="min-h-screen bg-[#f7f7f4] px-5 py-7 md:px-10 md:py-9">
    ...
    {selectedId !== null && bundle.data && (bundle.data.template.formType === "land_share" || bundle.data.template.formType === "sale_closing") && <ContractFormFiller bundle={bundle.data} preview={preview.data} />}
  </div>;
}
