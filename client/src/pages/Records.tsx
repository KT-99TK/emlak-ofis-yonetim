...
import { Banknote, Eye, EyeOff, FolderKanban, Plus, RefreshCw, ShieldCheck, UserRound } from "lucide-react";
...
export default function Records() {
  ...
  const visibleItems = (query.data ?? []).filter((item: any) => {
    ...
    return [item.referenceNo, item.name, item.email, item.phone, item.title, item.address, item.listingType]
      .filter(Boolean)
