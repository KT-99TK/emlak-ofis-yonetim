...
import { encodeOfflineClientDetails, offlineClientDisplayDetails } from "@/lib/offlineClientDetails";
...
export default function OfflineWorkspace() {
  ...
  const add = async () => {
    ...
    await saveOfflineRecord({
      entity,
      title: title.trim(),
      details: entity === "client" ? encodeOfflineClientDetails({ address: details.trim(), phone: clientPhone.trim(), identity: clientIdentity.trim() }) : details.trim(),
    ...
    setTitle(""); setDetails(""); setClientPhone(""); setClientIdentity(""); setAmount(""); setDueDate(""); setApprovalNote("");
