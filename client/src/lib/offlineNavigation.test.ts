...
describe("offline navigation", () => {
  ...
  it("keeps the contract and merge routes among local desktop destinations", () => {
    ...
    expect(offlineNavigationItems.map((item) => item.path)).toEqual(["#/offline", "#/offline-authority", "#/offline-rental", "#/offline-transactions", "#/offline-cash-bank", "#/offline-performance", "#/offline-targets", "#/offline-request-matches", "#/offline-merge", "#/offline-my-contracts", "#/offline-active-documents", "#/offline-requests", "#/offline-archive"]);
