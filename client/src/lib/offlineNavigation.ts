import { BarChart3, BellRing, ClipboardList, FileSignature, GitMerge, HardDrive, Target, UserRound } from "lucide-react";
...
export function normalizeOfflineHash(hash: string | undefined) {
  return hash === "#/offline-merge" || hash === "#/offline-authority" || hash === "#/offline-rental" || hash === "#/offline-performance" || hash === "#/offline-my-contracts" || hash === "#/offline-targets" || hash === "#/offline-requests" || hash === "#/offline-request-matches" ? hash : "#/offline";
}
