import { Archive, BarChart3, BellRing, ClipboardCheck, ClipboardList, FileLock2, FileSignature, GitMerge, HardDrive, Target, UserRound } from "lucide-react";
...
export function normalizeOfflineHash(hash: string | undefined) {
  return hash === "#/offline-merge" || hash === "#/offline-authority" || hash === "#/offline-rental" || hash === "#/offline-active-documents" || hash === "#/offline-archive" || hash === "#/offline-performance" || hash === "#/offline-my-contracts" || hash === "#/offline-targets" || hash === "#/offline-requests" || hash === "#/offline-request-matches" || hash === "#/offline-transactions" ? hash : "#/offline";
}
