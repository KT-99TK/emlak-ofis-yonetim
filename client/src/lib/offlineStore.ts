export type OfflineRecord = {
  id: string;
  entity: "client" | "property" | "contract" | "contractArchive" | "activeContractDocument" | "obligation" | "evacuation" | "ownerApproval" | "ledger" | "target" | "request" | "transaction" | "treasuryControl" | "internalControl";
  title: string;
  details: string;
  amount?: string;
  dueDate?: string;
...
export type OfflineAuditEvent = { id: string; action: "backup-exported" | "backup-verified" | "records-applied" | "manager-access-configured" | "manager-access-unlocked" | "manager-access-locked" | "contract-access-role-assigned" | "contract-access-scope-assigned" | "contract-archive-imported" | "contract-archive-opened" | "active-contract-document-uploaded" | "active-contract-document-opened" | "authority-eids-confirmed" | "treasury-entry-declared" | "treasury-entry-verified" | "treasury-control-reviewed" | "internal-budget-saved" | "internal-expense-declared" | "internal-expense-approved" | "internal-budget-transferred" | "internal-contribution-declared" | "internal-contribution-verified" | "internal-multi-party-contribution-declared" | "internal-vat-reference-saved"; userId: string; deviceId: string; at: string; metadata?: Record<string, string | number | boolean> };
