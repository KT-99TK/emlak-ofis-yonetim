export type OfflineRecord = {
  id: string;
  entity: "client" | "property" | "contract" | "contractArchive" | "activeContractDocument" | "obligation" | "evacuation" | "ownerApproval" | "ledger" | "target" | "request" | "transaction";
  title: string;
  details: string;
  amount?: string;
  dueDate?: string;
...
export type OfflineAuditEvent = { id: string; action: "backup-exported" | "backup-verified" | "records-applied" | "manager-access-configured" | "manager-access-unlocked" | "manager-access-locked" | "contract-access-role-assigned" | "contract-archive-imported" | "contract-archive-opened" | "active-contract-document-uploaded" | "active-contract-document-opened"; userId: string; deviceId: string; at: string; metadata?: Record<string, string | number | boolean> };
