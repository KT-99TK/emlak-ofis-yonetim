...
export function ContractFormFiller({ bundle, preview }: { bundle: FillerBundle; preview?: FillerPreview | null }) {
  ...
  // land_share'de iki ayrı basılabilir belge vardır (ana sözleşme + EK-1 Teknik Şartname). Aynı anda
  // ikisini de "authority-print-shell" içine koymak ikisini birden yazdırırdı (CSS sınıfı global);
  // bunun yerine tek shell'de hangi belgenin gösterileceğini bu state belirler.
  const [printTarget, setPrintTarget] = useState<"main" | "techSpec">("main");
