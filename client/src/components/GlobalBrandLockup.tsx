...
export default function GlobalBrandLockup({ className, variant = "default" }: GlobalBrandLockupProps) {
  ...
  return (
    <div className={cn(
      ...
      isOfflineSidebar
        ? "border border-white/15 bg-[#123f39] px-3 py-2.5 shadow-[0_12px_24px_rgba(16,62,56,.24)]"
      ...
      <div className={cn(
        ...
        <strong className={cn("my-0.5 font-serif font-semibold leading-none tracking-[0.04em]", isOfflineSidebar ? "text-[20px]" : "text-[18px]")}>1881</strong>
        <span className={cn("font-bold leading-none tracking-[0.08em]", isOfflineSidebar ? "text-[5px]" : "text-[4.5px]")}>GAYRİMENKUL</span>
      </div>
      <div className="min-w-0 leading-none">
        <p className={cn("truncate font-serif font-semibold tracking-[0.07em]", isOfflineSidebar ? "text-[18px] text-[#fffdf6]" : "text-[17px] text-[#183d37]")}>GLOBAL 1881</p>
