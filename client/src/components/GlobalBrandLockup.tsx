...
export default function GlobalBrandLockup({ className, variant = "default" }: GlobalBrandLockupProps) {
  ...
  return (
    <div className={cn(
      ...
      isOfflineSidebar
        ? "gap-2 border border-white/15 bg-[#123f39] px-2 py-2.5 shadow-[0_12px_24px_rgba(16,62,56,.24)]"
      ...
      <div className={cn(
        ...
        isOfflineSidebar ? "h-[58px] w-[58px]" : "h-14 w-14",
      )}>
      ...
      <div className="min-w-0 leading-none">
        <p className={cn("truncate whitespace-nowrap font-serif font-semibold", isOfflineSidebar ? "text-[16px] tracking-[0.04em] text-[#fffdf6]" : "text-[17px] tracking-[0.07em] text-[#183d37]")}>GLOBAL 1881</p>
