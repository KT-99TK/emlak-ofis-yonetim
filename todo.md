...
- [x] Dashboard TCMB kur kartı ve merkezi veri yükleniyor durumları için uzun bekleme halinde açık hata/yenileme geri dönüşü ekle; veri gelmezse kullanıcıya sonsuz yükleniyor mesajı gösterme. Merkezi özet, TCMB ve kişisel plan kartlarında 10 saniye timeout, açık hata metni ve “Tekrar dene” düğmesi bulunuyor; TypeScript, dashboard regression testi ve production build başarılı.
